...
# no data augmentations k-fold training yes pretrained model batch regularization
bash scripts/run_kfold.sh configs/model/hsi_classifier_densenet201_best.yaml configs/data/hsi_dermoscopy_croppedv2_notaug_batchr.yaml 5
